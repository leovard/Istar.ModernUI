...
namespace IstarWindows.ViewModels
{
        ...
        : NotifyPropertyChanged
    {
        ...
        public SettingsAppearanceViewModel()
        {
            ...
            Themes.Add(new Link { DisplayName = "bing image", Source = new Uri("/IstarWindows;component/Assets/ModernUI.BingImage.xaml", UriKind.Relative) });
            Themes.Add(new Link { DisplayName = "hello kitty", Source = new Uri("/IstarWindows;component/Assets/ModernUI.HelloKitty.xaml", UriKind.Relative) });
            Themes.Add(new Link { DisplayName = "love", Source = new Uri("/IstarWindows;component/Assets/ModernUI.Love.xaml", UriKind.Relative) });
            Themes.Add(new Link { DisplayName = "snowflakes", Source = new Uri("/IstarWindows;component/Assets/ModernUI.Snowflakes.xaml", UriKind.Relative) });
        ...
        private void SyncThemeAndColor()
        {
            ...
            SelectedTheme = Themes.FirstOrDefault(t => t.Source.Equals(AppearanceManager.Current.ThemeSource));
        ...
        public Color[] AccentColors => _selectedPalette == PaletteMetro ? _metroAccentColors : _wpAccentColors;
